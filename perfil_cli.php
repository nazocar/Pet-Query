    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left" style="width:200px;" id="mySidebar">
      ...
      <div class="w3-container">
        ...
        <form action="proc_atualizar_dados.php" method="POST">
            ...
            <div>
            <button type="submit" class="btn btn-primary mb-3" id="criar" style="width: 160px">Editar informações</button>
            </div>
            <div>
            <input type="hidden" value="<?php echo $id ?>" name="id_cli">
            <a href='#' data-bs-toggle='modal' data-bs-target='#excluir' class='btn mb-2 mt-3' style="width: 160px; background-color: #fff; border: 2px solid red; color: red">Excluir minha conta</a>
            </div>
          </div>
          ...
          <div class='modal fade' id="excluir" tabindex='-1' aria-labelledby='exampleModalLabel' aria-hidden='true'>
                ...
                <form method='POST' action='proc_apaga_cli.php'>
                <input type='hidden' name='id_cli' minlength='1' maxlength='100' class='form-control mb-3' value="<?php echo $id ?>">
                <h5>Você tem certeza de que deseja excluir sua conta?</h5>
                </div>
