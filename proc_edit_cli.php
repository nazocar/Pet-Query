<?php
    ...
    if (mysqli_affected_rows($mysqli)){
        $_SESSION['edit'] = "<div class='mb-2 mt-3' style='text-align: center'><span style='text-align: center; color: green; font-size: 1.5rem'>Usuário editado com sucesso" . "!" . "</span></div>";
        ...
        $_SESSION['edit'] =  "<div class='mb-2 mt-3' style='text-align: center'><span style='text-align: center; color: red; font-size: 1.5rem'>Usuário não foi editado." . "</span></div>";
        if(isset($_SESSION['adm'])){
            header("Location: painel.php");
        } else if (isset($_SESSION['fun'])){
            header("Location: painel_func.php");
